...
[SupportedProtocolType(ProtocolType.SiemensS200)]
public class SiemensS200Driver : TcpBaseProtocolDriver<SiemensS7Net>
{
    protected override SiemensS7Net CreateConnection(ProtocolDto protocol, CancellationToken token)
    {
        ...
        {
            var conn = new SiemensS7Net(SiemensPLCS.S200, lanProtocol.IpAddress)
            {
